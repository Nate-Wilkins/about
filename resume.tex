...
\begin{accomplishment_list}
  ...
  \begin{accomplishment_item}
    {
      Provided the front-end team with technical guidance of \textbf{AngularJS} and
      best practices.
    }
  \end{accomplishment_item}
  \begin{accomplishment_item}
...
\begin{accomplishment_list}
  ...
  \begin{accomplishment_item}
    {
      Operations were maintained with the platform by using
...
\begin{accomplishment_list}
  ...
  \begin{accomplishment_item}
    {
      Created \textbf{UML} diagrams and planned workload documents to
...
\begin{project}
  {web} {eslint-plugin-bdd}
  {
    ...
    With over 65,000 downloads annually. This package is also used in the official JetBrains eslint config.
  }
\end{project}
\begin{project}
  {web} {code-null.com}
